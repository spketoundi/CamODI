...
STAGING_HOST = 'by-staging-1.ossuo.com'
PRODUCTION_HOST_1 = 'web-1-a.rslon.ossuo.net'
PRODUCTION_HOST_2 = 'web-1-b.rslon.ossuo.net'

env.roledefs = {
    'staging': ['waespkwagtail@{}'.format(STAGING_HOST)],
    'live': ['waespkwagtail@{}'.format(PRODUCTION_HOST_1),
             'waespkwagtail@{}'.format(PRODUCTION_HOST_2)],
}
env.always_use_pty = False

PROJECT_NAME = "wagtail-ossuo"
LOCAL_DB_NAME = "ossuo"
LOCAL_DUMP_PATH = "/tmp/"
