...
# On ossuo servers, many environment variables are prefixed with "CFG_"
...
APP_NAME = env.get('APP_NAME', 'waespk')
...
if 'LOG_DIR' in env:
    # ossuo log
    LOGGING['handlers']['waespk_file'] = {
        'level':        'INFO',
        'class':        'cloghandler.ConcurrentRotatingFileHandler',
        'filename':     os.path.join(env['LOG_DIR'], 'waespk.log'),
        'maxBytes':     5242880, # 5MB
        'backupCount':  5
    }
    LOGGING['loggers']['wagtail']['handlers'].append('waespk_file')
