...
from waespk.core.models import BlogPage
from waespk.core.utils import play_filter


# Main blog feed

class BlogFeed(Feed):
    title = "The ossuo Blog"
    link = "/blog/"
    description = "The latest news and views from ossuo on the work we do, the web and the wider world"
...
class PlanetDrupalFeed(Feed):
    title = "The ossuo Planet Drupal Feed"
    link = "/blog/?tag=planet-drupal"
    description = "The ossuo Planet Drupal Feed"
