    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('image', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='ossuo.ossuoImage', null=True)),
                ('page', modelcluster.fields.ParentalKey(related_name='grants_managed', to='ossuo.GoogleAdGrantsPage')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(related_name='quotes', to='ossuo.GoogleAdGrantsPage')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='page',
            field=modelcluster.fields.ParentalKey(related_name='accreditations', to='ossuo.GoogleAdGrantsPage'),
