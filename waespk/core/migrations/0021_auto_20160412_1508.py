...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='blogpage',
            name='author_left',
            field=models.CharField(blank=True, help_text='author who has left ossuo', max_length=255),
        ),
        migrations.AlterField(
            model_name='blogpage',
            name='date',
