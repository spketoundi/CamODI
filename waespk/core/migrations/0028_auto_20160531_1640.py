...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ossuo', '0027_marketinglandingpagerelatedlink_email_link'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='featured_items', to='ossuo.MarketingLandingPage')),
