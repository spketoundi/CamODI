    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hero_video_poster_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='ossuo.ossuoImage')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_links', to='ossuo.MarketingLandingPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
