...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('advert', models.ForeignKey(related_name='+', to='ossuo.Advert')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_left', models.CharField(help_text=b'author who has left ossuo', max_length=255, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('sort_order', models.IntegerField(null=True, editable=False, blank=True)),
                ('page', modelcluster.fields.ParentalKey(related_name='tags', to='ossuo.BlogPage')),
                ('tag', models.ForeignKey(related_name='blog_page_tag_select', to='ossuo.BlogPageTagList')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(related_name='content_block', to='ossuo.JobIndexPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(related_name='job', to='ossuo.JobIndexPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort_order', models.IntegerField(null=True, editable=False, blank=True)),
                ('content', wagtail.wagtailcore.fields.RichTextField()),
                ('page', modelcluster.fields.ParentalKey(related_name='content_block', to='ossuo.ServicesPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort_order', models.IntegerField(null=True, editable=False, blank=True)),
                ('content', wagtail.wagtailcore.fields.RichTextField()),
                ('page', modelcluster.fields.ParentalKey(related_name='content_block', to='ossuo.StandardPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(related_name='renditions', to='ossuo.ossuoImage')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('page_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='wagtailcore.Page')),
                ('main_image', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='ossuo.ossuoImage', null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro', wagtail.wagtailcore.fields.RichTextField(blank=True)),
                ('body', wagtail.wagtailcore.fields.RichTextField(blank=True)),
                ('homepage_image', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='ossuo.ossuoImage', null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('sort_order', models.IntegerField(null=True, editable=False, blank=True)),
                ('image', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='ossuo.ossuoImage', null=True)),
                ('page', modelcluster.fields.ParentalKey(related_name='screenshots', to='ossuo.WorkPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('sort_order', models.IntegerField(null=True, editable=False, blank=True)),
                ('page', modelcluster.fields.ParentalKey(related_name='tags', to='ossuo.WorkPage')),
                ('tag', models.ForeignKey(related_name='work_page_tag_select', to='ossuo.BlogPageTagList')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.AddField(
            model_name='standardpagerelatedlink',
            name='page',
            field=modelcluster.fields.ParentalKey(related_name='related_links', to='ossuo.StandardPage'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='standardpageclients',
            name='image',
            field=models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='ossuo.ossuoImage', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='standardpageclients',
        ...
        migrations.AddField(
            model_name='standardpageclients',
            name='page',
            field=modelcluster.fields.ParentalKey(related_name='clients', to='ossuo.StandardPage'),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='servicespagerelatedlink',
            name='page',
            field=modelcluster.fields.ParentalKey(related_name='related_links', to='ossuo.ServicesPage'),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='personpagerelatedlink',
            name='page',
            field=modelcluster.fields.ParentalKey(related_name='related_links', to='ossuo.PersonPage'),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='blogpagerelatedlink',
            name='page',
            field=modelcluster.fields.ParentalKey(related_name='related_links', to='ossuo.BlogPage'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='blogpageauthor',
            name='author',
            field=models.ForeignKey(related_name='+', blank=True, to='ossuo.PersonPage', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='blogpageauthor',
            name='page',
            field=modelcluster.fields.ParentalKey(related_name='related_author', to='ossuo.BlogPage'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='blogpage',
        ...
        migrations.AddField(
            model_name='blogindexpagerelatedlink',
            name='page',
            field=modelcluster.fields.ParentalKey(related_name='related_links', to='ossuo.BlogIndexPage'),
            preserve_default=True,
        ),
        migrations.AddField(
