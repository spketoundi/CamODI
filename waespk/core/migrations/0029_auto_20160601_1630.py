...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='intro_related_links', to='ossuo.MarketingLandingPage'),
        ),
        migrations.AddField(
            model_name='marketinglandingpageheaderrelatedlink',
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='header_related_links', to='ossuo.MarketingLandingPage'),
        ),
    ]
