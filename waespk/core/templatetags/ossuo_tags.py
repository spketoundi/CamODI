...
from waespk.core.models import *
from waespk.core.utils import *
...
@register.inclusion_tag('ossuo/tags/homepage_people_listing.html', takes_context=True)
...
@register.inclusion_tag('ossuo/tags/homepage_blog_listing.html', takes_context=True)
...
@register.inclusion_tag('ossuo/tags/homepage_work_listing.html', takes_context=True)
...
@register.inclusion_tag('ossuo/tags/homepage_job_listing.html', takes_context=True)
...
# Advert snippets
@register.inclusion_tag('ossuo/tags/adverts.html', takes_context=True)
def adverts(context):
    return {
...
@register.inclusion_tag('ossuo/tags/person_blog_listing.html', takes_context=True)
...
@register.inclusion_tag('ossuo/tags/work_and_blog_listing.html', takes_context=True)
