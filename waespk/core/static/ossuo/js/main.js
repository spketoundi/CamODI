...
$(document).ready(function() {
    waespk.heroImages();
    waespk.mobileMenu();
    waespk.loadMore($('.clients'));
    waespk.loadMore($('.blog-listing'));
    waespk.jobs();
    waespk.scrollEvents();
    waespk.servicesCarousel();
    waespk.newsletterSignUp();
});
...
var waespk = {
    ...
    map: function() {
        ...
        locations       = [
            [51.858469, -1.480863, 'HeadQr'],
            [51.454814, -2.597802, 'mBranch'],
        ...
        function setMarkers(map, locations) {
            ...
            for (i = 0; i < locations.length; i++) {
                ...
                var marker = new google.maps.Marker({
                    ...
                    title:      title,
                    icon:       '{% static "ossuo/images/pin.png" %}'
                });
